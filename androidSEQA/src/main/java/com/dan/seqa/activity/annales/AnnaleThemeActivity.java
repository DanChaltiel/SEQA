...
import com.dan.seqa.fragments.ChoixThemeDialogFragment;
import com.dan.seqa.modeles.AnnaleModel;

public class AnnaleThemeActivity extends AbstractAnnaleActivity{
	//CONSTANTES
	...
	protected void createPager(){
		...
		pager.setOnPageChangeListener(new ViewPager.SimpleOnPageChangeListener() {
			...
			public void onPageSelected(int position) { //position va de 0 à x-1 ?
				...
				goNextButton.setEnabled(position != totalFrag);
			}
		});
